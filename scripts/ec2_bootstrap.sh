...
pip install -U datasets requests swebench swesmith
...
echo "3) Export OpenAI vars if using API:"
echo "   export OPENAI_BASE_URL=https://api.openai.com/v1"
echo "   export OPENAI_API_KEY=YOUR_KEY"
echo "4) Run a quick test:"
echo "   python scripts/run_verified_mini_baseline.py --model gpt-5-nano --limit 3 --max_workers_eval 1"
