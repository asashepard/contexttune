...
LITELLM_MAX_TOKENS="${LITELLM_MAX_TOKENS:-512}"
VLLM_MAX_MODEL_LEN="${VLLM_MAX_MODEL_LEN:-19968}"
MSWEA_COST_TRACKING="${MSWEA_COST_TRACKING:-ignore_errors}"
MSWEA_SWEBENCH_CONFIG="${MSWEA_SWEBENCH_CONFIG:-}"

export LITELLM_MAX_TOKENS
export VLLM_MAX_MODEL_LEN
export MSWEA_COST_TRACKING
export MSWEA_SWEBENCH_CONFIG
...
log "LITELLM_MAX_TOKENS: $LITELLM_MAX_TOKENS"
log "VLLM_MAX_MODEL_LEN: $VLLM_MAX_MODEL_LEN"
log "MSWEA_COST_TRACKING: $MSWEA_COST_TRACKING"
log "MSWEA_SWEBENCH_CONFIG: ${MSWEA_SWEBENCH_CONFIG:-<empty>}"
