...
echo "   python scripts/run_inference.py --model openai/<model> --runner mini_swe_agent_swebench --ablation baseline_context --instance_ids_file scripts/smoke_3_ids.txt --timeout_s 600"
